...
<head>
    ...
    <link href="/fnc/icon/favicon.png" rel="shortcut icon">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="flat-infomation">
                        ...
                        <li class="email">Email: <a href="mailto:themesflat@gmail.com" title="email">themesflat@gmail.com</a></li>
                    </ul><!-- /flat-infomation -->
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="<?= Url::to (['/blog/blog']) ?>" title="">Блог</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="../../../../../Users/MANY/Downloads/FNC/FNC/fnc-package/fnc/404.html" title="">Error Page</a></li>
                                        <li><a href="../../../../../Users/MANY/Downloads/FNC/FNC/fnc-package/fnc/pricing.html" title="">Pricing</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                <li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="widget-ft widget-about">
                        <div id="logo-ft">
                            <a href="#" title="">
                                <img src="../../../../../Users/MANY/Downloads/FNC/FNC/fnc-package/fnc/images/logo-ft.png" alt="">
                            </a>
                        </div>
